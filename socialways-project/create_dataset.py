...
annot_file = './socialways-project/dataset/data_zara01/obsmat.txt'   # annot_file = 'path-to-dataset/obsmat.txt'   # FixMe: fix the input address
npz_out_file = './socialways-project/output-data/data-14-11.npz'      # npz_out_file = '../data-8-12.npz'           # FixMe: fix the output filename
parser = BIWIParser()
